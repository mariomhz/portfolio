...
const DESCRIPTION =
  "Fullstack developer based in Tenerife, Canary Islands. Tecnico Superior en Desarrollo de Aplicaciones Web (DAW). Java, C#, JavaScript, TypeScript, Spring Boot, .NET, MySQL and Linux. Open to junior developer and technical support roles, remote or on-island.";
